...
/*						{content: "--:--", className: "enyo-label", style: "color: gray;font-size: 12px;"}*/
        ...
        {kind: "PalmService", name: "upnpDiscover", service: "palm://org.e.lnx.wee.homecontrol.service.upnp", method: "discover",
            onSuccess: "discoverySuccess", onFailure: "discoveryFailure"
        },
        {kind: "PalmService", name: "upnpCommand", service: "palm://org.e.lnx.wee.homecontrol.service.upnp", method: "sendCommand",
